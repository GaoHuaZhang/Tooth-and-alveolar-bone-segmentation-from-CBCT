    ...
    for x in range(0, sx):
        ...
        for y in range(0, sy):
            ...
            for z in range(0, sz):
                ...
                skl_off[:, xs:xs + patch_size[0], ys:ys + patch_size[1], zs:zs + patch_size[2]] = skl_off[:,
                                                                                                  xs:xs + patch_size[0],
                                                                                                  ys:ys + patch_size[1],
                                                                                                  zs:zs + patch_size[
                                                                                                      2]] + skl_off_patch[
                ...
                cnt_off[:, xs:xs + patch_size[0], ys:ys + patch_size[1], zs:zs + patch_size[2]] = cnt_off[:,
                                                                                                  xs:xs + patch_size[0],
                                                                                                  ys:ys + patch_size[1],
                                                                                                  zs:zs + patch_size[
                                                                                                      2]] + cnt_off_patch[
                                                                                                            ...
                                                                                                            :]
                # seg
                y = (F.softmax(seg_cnt_patch, dim=1).cpu().data.numpy() + F.softmax(seg_skl_patch,
                                                                                    dim=1).cpu().data.numpy()) / 2
                y = y[0, :, :, :, :]
                score_map[:, xs:xs + patch_size[0], ys:ys + patch_size[1], zs:zs + patch_size[2]] = score_map[:,
                                                                                                    xs:xs + patch_size[
                                                                                                        0],
                                                                                                    ys:ys + patch_size[
                                                                                                        1],
                ...
                cnt[xs:xs + patch_size[0], ys:ys + patch_size[1], zs:zs + patch_size[2]] = cnt[xs:xs + patch_size[0],
                                                                                           ys:ys + patch_size[1],
